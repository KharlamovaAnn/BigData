...
**Вариант 14:** Платформа интернета вещей (IoT): сбор данных с миллионов устройств, мониторинг их состояния, предиктивное обслуживание, предоставление аналитики пользователям. Источники: MQTT/AMQP брокеры, сенсорные данные.
